...
import os
os.environ['IMAGENET_LOC_ENV'] = '/projects/ml4science/AttackVLM'
...
# eps=32 ######################
# Attack_Global('resnet50', 0, 'ddim50', t=3, eps=16, iter=10, name='attack_global_gradpass', alpha=2, version='v2') # original
Attack_Global('resnet50', 0, 'ddim50', t=3, eps=16, iter=10, name='attack_global_gradpass', alpha=2, version='v1')
